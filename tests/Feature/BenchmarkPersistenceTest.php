...
test('it can write benchmark summaries to a configured log path', function () {
    $logPath = storage_path('logs/custom-benchmark.log');
    ...
    $importer = new class {
        ...
        {
            return $key === 'benchmark-log'
                ? 'storage/logs/custom-benchmark.log'
                : null;
        }
    ...
    $summary = [
        'timestamp' => '2026-02-07T20:03:00+06:00',
        'strategy' => 'mysql_load_data_local_infile',
        'dataset' => 'users-100.csv',
        'file' => '/tmp/users-100.csv',
        'execution_time_seconds' => 0.123456,
...
test('it can disable benchmark summary logging', function () {
    $logPath = storage_path('logs/benchmark.log');
    ...
    $importer = new class {
        ...
        public function option(string $key): ?string
        {
            return $key === 'benchmark-log' ? 'false' : null;
        }
